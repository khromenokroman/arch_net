...
:inetRouter => {
  ...
  :office1Router => {
    ...
    :net => [
               ...
               {ip: '192.168.2.193', adapter: 6, netmask: "255.255.255.192", virtualbox__intnet: "hardware-office1"}
            ]
  },
  ...
  :office2Router => {
    ...
    :net => [
              ...
              {ip: '192.168.1.193', adapter: 5, netmask: "255.255.255.192", virtualbox__intnet: "hardware-office2"}
            ]
  }, 
